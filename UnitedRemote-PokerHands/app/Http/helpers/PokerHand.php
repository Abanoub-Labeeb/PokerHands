  ...
  */
  ...
  public function setRank() {
    ...
    elseif ($this->isFlush() && $this->isStraight()) {
      ...
      if(array_key_exists("four",$this->sets)){
        // Four of a kind.
        $this->hand_rank = 8;
      }
      elseif (array_key_exists("three",$this->sets) && count($this->sets['pair']) > 0) {
        // Full House.
        $this->hand_rank = 7;
      }
      elseif ($this->isFlush()) {
      ...
      elseif (array_key_exists("three",$this->sets)) {
        // Three of a kind
        $this->hand_rank = 4;
      }
      elseif (array_key_exists("pair",$this->sets) && count($this->sets['pair']) > 1) {
        // Two pair.
        $this->hand_rank = 3;
      }
      elseif (array_key_exists("pair",$this->sets) && count($this->sets['pair']) > 0) {
        // One pair.
        $this->hand_rank = 2;
      }
      else {
